...
*** TODO [[http://mitpress.mit.edu/sicp/full-text/book/book-Z-H-29.html#%_sec_4.4.1][4.4.4: Deductive Information Retrieval]] [7/10]
...
(or (salary (Bitdiddle Ben) ?bb-amount)
...
#+BEGIN_SRC scheme
(rule (substitute-for ?person-1 ?person-2)
...
- a. all people who can replace Cy D. Fect;
     ...
     #+BEGIN_SRC scheme
     (substitute-for ?person (Fect Cy D))
     #+END_SRC
