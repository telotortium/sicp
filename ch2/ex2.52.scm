...
;;; a.
;;;
;;; Add some segments to the primitive wave painter of exercise  2.49 (to add
;;; a smile, for example).

;;; b.
;;;
;;; Change the pattern constructed by corner-split (for example, by using only
...
; I'll take a pass on this too, since I don't have the drawing system
