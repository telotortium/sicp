...
#+BEGIN_SRC scheme :tangle install-scheme-number-package.scm
...
#+BEGIN_SRC scheme :tangle type-tag-scheme-number.scm
  (define (attach-tag type-tag contents)
...
#+BEGIN_SRC scheme
  ...
  (define (neg-complex z)
    (make-from-real-imag (- (real-part z))
                         (- (imag-part z))))
  (put 'neg 'poly-sparse neg-poly-sparse)
...
#+BEGIN_SRC scheme
  ...
  (define (div-poly-sparse p1 p2)
    (if (same-variable? (variable p1)
        ...
        (error "DIV-POLY -- division between different variables NYI")))
#+END_SRC
...
#+BEGIN_SRC scheme
  (define t1 '((5 1) (0 -1)))
  (define t2 '((2 1) (0 -1)))
  (define p1 (make-poly-sparse 'x t1))
  (define p2 (make-poly-sparse 'x t2))
  (define quotient-terms '((3 1) (1 1)))
  (define remainder-terms '((1 1) (0 -1)))
  (test (list quotient-terms remainder-terms)
        (div-terms t1 t2))
#+END_SRC
