...
#+BEGIN_SRC scheme :tangle poly-sparse-package.scm
  ...
  (define (install-poly-sparse-package)
    ...
    (put 'div '(poly-sparse poly-sparse)
         (lambda (x y) (tag (div-poly-sparse x y))))
...
#+BEGIN_SRC scheme :tangle ex-2-91-test.scm
  ...
  (define quotient-terms (make-poly-sparse 'x '((3 1) (1 1))))
  (define remainder-terms (make-poly-sparse 'x '((1 1) (0 -1))))
  (test (list quotient remainder)
        (div p1 p2))
#+END_SRC
...
#+BEGIN_SRC scheme :tangle ex-2-94-test
  (include "poly-sparse-package")
